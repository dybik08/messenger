...
import { sendMessage, fetchMessages } from 'services/messages/messages.actions';
...
export class Chat extends React.Component<IProps, IState> {
    ...
    render() {
        const messages =
            ...
            this.props.messages.messages[this.state.current].items ? this.props.messages.messages[this.state.current].items : [];
